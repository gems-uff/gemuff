...
namespace GEMUFF {
    ...
    namespace Hash {
         ...
         * Base class for hash
         */
        class GEMUFFLIB_EXPORT AbstractHash {
        private:
            HashType hashType;
         ...
         * MD5 Hash
         */
        class GEMUFFLIB_EXPORT MD5Hash : public AbstractHash {
        private:
        ...
        class GEMUFFLIB_EXPORT DCTHash : public AbstractHash{
        private:
            ulong64 hash;
        ...
        class GEMUFFLIB_EXPORT MarrHildretchHash : public AbstractHash {
        private:
            uint8_t *hash;
